  ...
  return (
    <footer className="bg-[#0B1628] text-white/60">
      <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16">
        {/* FIX: 1 col mobile, 2 col sm, 4 col lg */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-10 sm:mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-[2px] text-white mb-4 sm:mb-5">Quick Links</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-[2px] text-white mb-4 sm:mb-5">Services</h4>
            <ul className="space-y-2">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-[2px] text-white mb-4 sm:mb-5">Contact</h4>
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2.5">
                <Mail className="w-4 h-4 text-[#00A896] flex-shrink-0 mt-0.5" />
                {/* FIX: email wraps with break-all on mobile */}
        ...
        {/* FIX: stacked on mobile, row on md+ */}
        <div className="border-t border-white/10 pt-6 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
