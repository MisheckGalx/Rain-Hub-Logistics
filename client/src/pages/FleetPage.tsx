    ...
    <main className="pt-20">
      ...
      <div className="relative min-h-[280px] sm:min-h-[360px] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1473448912268-2022ce9509d8?w=1600&auto=format&fit=crop" alt="Fleet" className="w-full h-full object-cover opacity-25" />
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 py-12 sm:py-16">
          ...
          <p className="text-white/70 text-sm sm:text-lg max-w-xl leading-relaxed">
            Modern, well-maintained vehicles designed to handle diverse cargo requirements.
          </p>
        </div>
      </div>
      ...
      <section className="py-12 sm:py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6">
            ...
            {fleetData.map((truck) => (
              <div key={truck.name} className="bg-white rounded-2xl overflow-hidden border border-gray-200 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                <div className="relative h-48 sm:h-64 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 right-3 bg-[#0B1628]/85 text-[#00A896] font-black text-2xl sm:text-3xl px-3 sm:px-4 py-2 rounded-xl border border-[#00A896]/30" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                    {truck.capacity}
                  </div>
                </div>
                <div className="p-6 sm:p-8">
                  <h3 className="text-2xl sm:text-3xl font-black text-[#0B1628] mb-3 tracking-wide" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>{truck.name}</h3>
                  <p className="text-gray-500 text-sm leading-relaxed mb-5">{truck.desc}</p>
                  {/* FIX: pills wrap cleanly */}
          ...
          {/* FIX: 2 col mobile, 4 col lg */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((f) => (
              <div key={f.title} className="bg-white border border-gray-200 rounded-2xl p-5 sm:p-7 text-center hover:border-[#00A896] hover:shadow-lg transition-all duration-300">
                <div className="text-3xl mb-3">{f.icon}</div>
                <h4 className="text-lg sm:text-xl font-black text-[#0B1628] mb-2 tracking-wide" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>{f.title}</h4>
      ...
      {/* Coverage Section */}
      <section className="py-14 sm:py-20 bg-[#0B1628]">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="font-black text-white leading-none mb-5 tracking-wide" style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(32px, 5vw, 60px)" }}>
            ...
            {/* FIX: map scales correctly, aspect-video keeps proportions */}
            <div className="bg-[#0a1a2e] border border-white/10 rounded-2xl overflow-hidden w-full aspect-video flex items-center justify-center p-4 sm:p-6">
              <svg viewBox="0 0 400 300" className="w-full h-full">
                ...
                <text x="210" y="192" fontSize="9" fill="rgba(255,255,255,0.7)" fontFamily="sans-serif" fontWeight="600">Johannesburg</text>
                ...
                <circle cx="195" cy="130" r="4" fill="rgba(255,255,255,0.5)" /><text x="203" y="133" fontSize="8" fill="rgba(255,255,255,0.5)" fontFamily="sans-serif">Harare</text>
                <circle cx="235" cy="175" r="4" fill="rgba(255,255,255,0.5)" /><text x="243" y="178" fontSize="8" fill="rgba(255,255,255,0.5)" fontFamily="sans-serif">Maputo</text>
                <circle cx="158" cy="175" r="4" fill="rgba(255,255,255,0.5)" /><text x="100" y="178" fontSize="8" fill="rgba(255,255,255,0.5)" fontFamily="sans-serif">Gaborone</text>
                <circle cx="195" cy="248" r="4" fill="rgba(255,255,255,0.5)" /><text x="168" y="260" fontSize="8" fill="rgba(255,255,255,0.5)" fontFamily="sans-serif">Cape Town</text>
              </svg>
            </div>
          </div>
        </div>
