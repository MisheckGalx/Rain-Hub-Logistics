    ...
    <main className="pt-20">
      ...
      <div className="relative min-h-[280px] sm:min-h-[360px] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?w=1600&auto=format&fit=crop" alt="About" className="w-full h-full object-cover opacity-25" />
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="relative">
              ...
              />
              {/* FIX: accent badge only shows on md+ to avoid overlap on small screens */}
              <div className="absolute -bottom-4 -right-4 w-40 h-28 bg-gradient-to-br from-[#0055A5] to-[#00A896] rounded-2xl p-4 text-white hidden md:block">
                <div className="text-4xl font-black leading-none mb-1" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>SADC+</div>
                <div className="text-xs text-white/75 uppercase tracking-widest leading-relaxed">Region Coverage & Beyond</div>
              </div>
            </div>

            <div className="lg:pl-4">
              <h2 className="font-black text-[#0B1628] leading-none mb-5 tracking-wide" style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(32px, 5vw, 60px)" }}>
                CENTRE OF LOGISTICS EXCELLENCE
              </h2>
              <p className="text-gray-500 text-sm sm:text-base leading-relaxed mb-4">
                Rain Hub Logistics is a comprehensive logistics solutions provider dedicated to delivering reliable, efficient, and cost-effective freight services across the SADC region and beyond.
              </p>
              ...
              {/* FIX: stats row wraps on mobile */}
              <div className="flex gap-4 flex-wrap">
                <div className="flex-1 min-w-[100px] bg-gray-50 rounded-xl p-4 text-center">
          ...
          {/* Mission & Vision — FIX: stacked on mobile */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-12 sm:mt-20">
            <div className="bg-gradient-to-br from-[#0B1628] to-[#0055A5] rounded-2xl p-8 text-white">
            ...
            <div className="bg-gradient-to-br from-[#00A896] to-[#007a6e] rounded-2xl p-8 text-white">
      ...
      <section className="py-14 sm:py-20 bg-[#0B1628]">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <h2 className="font-black text-white tracking-wide" style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(40px, 7vw, 72px)" }}>
              CORE VALUES
            </h2>
          </div>
          {/* FIX: 1 col mobile, 2 col sm, 5 col lg */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-5">
            {values.map((v) => (
              <div key={v.num} className="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-7 hover:bg-white/10 hover:border-[#00A896]/40 transition-all duration-300">
                <div className="text-5xl font-black text-[#00A896]/25 leading-none mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>{v.num}</div>
                <h4 className="text-xl font-black text-white mb-2 tracking-wide" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>{v.title}</h4>
