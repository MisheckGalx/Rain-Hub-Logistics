...
const services = [
  {
    ...
    fullDesc: "Our road freight service provides reliable, efficient transportation across the SADC region. We operate a modern fleet of well-maintained vehicles ranging from 8-tonne trucks to 36-tonne super link trucks, ensuring we can handle any cargo size or requirement. With experienced drivers and advanced route planning technology, we guarantee on-time delivery with full cargo visibility throughout transit.",
    features: [
  ...
  },
  {
    ...
    fullDesc: "Our sea freight services connect Africa to the world. We manage the complete import and export cycle including booking, documentation, port coordination, and delivery to your door. We handle both containerized and breakbulk cargo with competitive rates through our established carrier relationships at major South African ports.",
    features: [
  ...
  },
  {
    ...
    fullDesc: "When time is critical, our air freight service delivers. We offer express and standard air cargo solutions for shipments that demand speed and security. Perfect for time-sensitive deliveries, high-value goods, or perishables that cannot wait.",
    features: [
  ...
  },
  {
    ...
    fullDesc: "Navigating customs compliance is complex. Our team of experienced customs agents handles all documentation, tariff classification, duty assessment, and regulatory compliance so your cargo clears without delays. We ensure full SARS compliance for all import and export declarations.",
    features: [
  ...
  },
  {
    ...
    fullDesc: "Need transport capacity without the overhead? Our truck hire service gives you access to professional drivers and well-maintained vehicles on-demand, whether for a single trip or long-term contract. All vehicles are insured and compliant.",
    features: [
      ...
      <div className="relative min-h-[360px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 py-16">
          ...
          <p className="text-white/70 text-lg max-w-xl leading-relaxed">
            Comprehensive logistics solutions tailored to your business — road, sea, air freight, customs clearance, and truck hire.
          </p>
        </div>
      </div>
                ...
                return (
                  ...
                  >
                    <div className="relative h-52 overflow-hidden">
                      ...
                      <span className="absolute top-4 left-4 bg-[#F4A022] text-[#0B1628] text-xs font-bold tracking-widest uppercase px-3 py-1 rounded-md">
                        {service.badge}
                      </span>
                    </div>
                    <div className="p-7">
                      <div className="w-12 h-12 bg-gradient-to-br from-[#0055A5]/10 to-[#00A896]/10 rounded-xl flex items-center justify-center mb-4">
                        <Icon className="w-6 h-6 text-[#0055A5]" />
                      </div>
                      <h3 className="text-2xl font-black text-[#0B1628] mb-3 tracking-wide" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                        {service.title}
                      </h3>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-6">
            <button
              ...
              className="inline-flex items-center gap-2 text-[#0055A5] font-semibold text-sm mb-10 hover:gap-4 transition-all"
            >
            ...
            {selected && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl">
                ...
                <div>
                  ...
                  <h2 className="text-5xl md:text-7xl font-black text-[#0B1628] leading-none mb-6 tracking-wide" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                    {selected.title.toUpperCase()}
                  </h2>
                  <p className="text-gray-500 text-base leading-relaxed mb-4">{selected.fullDesc}</p>
                  ...
                  <button
                    ...
                    className="mt-8 bg-[#F4A022] hover:bg-[#e8940f] text-[#0B1628] font-bold px-8 py-4 rounded-lg text-sm uppercase tracking-wide transition-all hover:-translate-y-1 hover:shadow-lg"
                  >
